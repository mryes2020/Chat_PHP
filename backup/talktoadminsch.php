...
<body>
	...
	<p>This is the talk to admins channel</p>
	<div class="links"> |
		<a href="./generalch.php" class="link">General</a> |
		<a href="./programmingch.php" class="link">Programming</a> |
		...
		<a href="./talktoadminsch.php" class="link active-link">Talk to admins</a> |
	</div> 
	<p>Admins are: <span class="admin">@MR.hakarman</span> and <span class="admin">@MR.69</span></p>
...
<script type="text/javascript">
		...
		$('#message').keypress(function(e) {	
			...
			if(e.which == 13 ) {
				...
				$.post('./handlers/ajax.php?action=SendMessagetalktoadmins&message='+message, function(response){
		...
		function loadChat()
		{
			$.post('handlers/ajax.php?action=getChattalktoadmins', function(response){
