...
<body>
	...
	<p>This is the general channel</p>
	<div class="links"> |
		<a href="./generalch.php" class="link active-link">General</a> |
...
<script type="text/javascript">
		...
		$('#message').keypress(function(e) {	
			...
			if(e.which == 13 ) {
				...
				$.post('./handlers/ajax.php?action=SendMessagegeneral&message='+message, function(response){
