...
<script type="text/javascript">
		...
		$('#message').keypress(function(e) {	
			...
			if(e.which == 13 ) {
				...
				$.post('./handlers/ajax.php?action=SendMessagehacking&message='+message, function(response){
		...
		function loadChat()
		{
			$.post('handlers/ajax.php?action=getChathac', function(response){
