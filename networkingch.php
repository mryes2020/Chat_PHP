...
<body>
	...
	<p>This is the networking channel</p>
	<div class="links"> |
		...
		<a href="./networkingch.php" class="link active-link">Networking</a> |
...
<script type="text/javascript">
		...
		$('#message').keypress(function(e) {	
			...
			if(e.which == 13 ) {
				...
				$.post('./handlers/ajax.php?action=SendMessagenetworking&message='+message, function(response){
		...
		function loadChat()
		{
			$.post('handlers/ajax.php?action=getChatnet', function(response){
