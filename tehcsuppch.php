...
<body>
	...
	<p>This is the tech support channel</p>
	<div class="links"> |
		...
		<a href="./tehcsuppch.php" class="link active-link">Tech support</a> |
...
<script type="text/javascript">
		...
		$('#message').keypress(function(e) {	
			...
			if(e.which == 13 ) {
				...
				$.post('./handlers/ajax.php?action=SendMessagetehcsupp&message='+message, function(response){
		...
		function loadChat()
		{
			$.post('handlers/ajax.php?action=getChattehcs', function(response){
